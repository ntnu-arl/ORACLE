...
WAYPOINT_FILE = 'waypoints/gallery/vsep_dense1/waypoint_gallery_Explore.txt'
...
MAX_INITIAL_X = 2.5 # meters
MAX_INITIAL_Y = 9.5 # meters
MAX_INITIAL_Z = 1.0 # meters
MAX_INITIAL_YAW = -180 # degrees
MIN_INITIAL_X = 2.5 # meters
MIN_INITIAL_Y = 9.5 # meters
MIN_INITIAL_Z = 1.0 # meters
MIN_INITIAL_YAW = -180.0 # degrees
