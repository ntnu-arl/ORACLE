...
CPN_TF_CHECKPOINT_PATH = ['model_weights/vel_2_0/net1/saved-model.hdf5', # SKIP_STEP_GENERATE = 3, ACTION_HORIZON = 14, VEL_MAX = 3.5 m/s
...
CPN_TRT_CHECKPOINT_PATH = ['model_weights/vel_2_0/net1',
                        'model_weights/vel_2_0/net2',
                        'model_weights/vel_2_0/net3',
                        'model_weights/vel_2_0/net4',
                        'model_weights/vel_2_0/net5']
...
############### PLANNING PARAMS ###############
PLANNING_TYPE = 2 # 0: end2end ORACLE, 1: seVAE-ORACLE, 2: A-ORACLE, 3: voxblox
...
PLANNING_VERTICAL_FOV = 58.0 # degrees
STEPS_TO_REPLAN = 3 # replan after ... depth images
CMD_VELOCITY = 0.75
...
INFOGAIN_USE_TENSORRT = False #True
...
WAYPOINT_FILE = 'waypoints/waypoint_urban_station_v2.txt'
WAYPOINT_DISTANCE_THRESHOLD = 1.0
WAYPOINT_YAW_THRESHOLD = np.deg2rad(10.0)
...
# ROS topics in sim
SIM_DEPTH_TOPIC = '/delta/rgbd/camera_depth/depth'
...
NUM_EPISODES_EVALUATE = 1
EPISODE_TIMEOUT = 1000 # seconds
MAX_INITIAL_X = -22.0 # meters
MAX_INITIAL_Y = -8.0 # meters
MAX_INITIAL_Z = 2.0 # meters
MAX_INITIAL_YAW = 90 # degrees
MIN_INITIAL_X = -22.0 # meters
MIN_INITIAL_Y = -8.0 # meters
MIN_INITIAL_Z = 2.0 # meters
MIN_INITIAL_YAW = 90 # degrees

# simulated params in Flightmare (only used when SIM_USE_FLIGHTMARE = True): match config from agile_autonomy
SIM_USE_FLIGHTMARE = False # only used when RUN_IN_SIM = True
