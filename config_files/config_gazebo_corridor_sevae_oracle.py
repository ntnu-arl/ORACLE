...
# collision cost
DEADEND_COL_SCORE_THRESHOLD_HIGH = 3.5 # allow to yaw in spot to find new free direction
DEADEND_COL_SCORE_THRESHOLD_LOW = 1.5 # exit yawing in dead end mode 
TIME_WEIGHT_FACTOR = 0.04 # 0.0: zero effect
COLLISION_THRESHOLD = 0.15 #0.2 #0.04 # threshold (compared to the safest action sequence) before checking goal_dir
