...
############### PLANNING PARAMS ###############
PLANNING_TYPE = 0 # 0: end2end ORACLE, 1: seVAE-ORACLE, 2: A-ORACLE, 3: voxblox
...
SKIP_STEP_GENERATE = 3 # number of depth images to skip before recording data
# make sure: ACTION_HORIZON * SKIP_STEP_GENERATE * DEPTH_TS * VEL_MAX <= MAX_RANGE
ACTION_HORIZON = 14 # predict the collision probabilities only after SKIP_STEP_GENERATE steps
